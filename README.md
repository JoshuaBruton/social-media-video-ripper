...
The user can then copy & paste any video 'url' they wish to save - press Enter - you will be asked for one more input, and that's for them to name the video file. Once that is entered, you can see the download in the terminal as well as a finished message.
